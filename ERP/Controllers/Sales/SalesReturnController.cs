...
namespace ERP.Controllers.Sales
{
    public class SalesReturnController : Controller
    {
        ...
        public async Task<IActionResult> SalesReturnVoucher(int page = 1, int pageSize = 5, string activeTab = "form")
        {
        ...
        {
            var salesReturn = await _context.StockMaster
                .Include(u => u.User)
        ...
        public async Task<IActionResult> Delete(int id)
        {
            try
            {
                ...
                var journalEntry = await _context.JournalEntry
                    .FirstOrDefaultAsync(je => je.etype == "SalesReturn" && je.description == $"Sales Return Entry for StockMaster {id}");
